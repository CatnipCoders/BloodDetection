...
import { Fingerprint, UserPlus, Shield, Activity } from "lucide-react"
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          ...
          <Card className="hover:shadow-lg transition-shadow border-purple-100">
            <CardHeader>
              ...
              <CardTitle className="text-xl">Vital Signs Monitor</CardTitle>
              <CardDescription>Monitor SpO2 and heart rate in real-time using ESP32 sensors</CardDescription>
            </CardHeader>
            <CardContent>
              <Link href="/vitals">
                <Button className="w-full bg-purple-600 hover:bg-purple-700">Start Monitoring</Button>
              </Link>
            </CardContent>
          </Card>
